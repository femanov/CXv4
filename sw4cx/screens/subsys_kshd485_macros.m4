...
# 1:name/base
define(`KSHD485_CELL', `
    container cell "KShD485: $1" \
             lrtb "" base:$1 content:3 {
...
# 1:name/base 2:dev_prefix
define(`KSHD485_LINE', `
    button "" $1   arrowup \
            r:"_all_code; getchan $2$1.status_km; ret;" \
            w:"_all_code; push -1000000; putchan $2$1.go_n_steps; ret;"
    button "" ""   arrowdn \
            r:"_all_code; getchan $2$1.status_kp; ret;" \
            w:"_all_code; push +1000000; putchan $2$1.go_n_steps; ret;"
    button "" STOP button  r:$2$1.stop
    container -$1_ctl "..." subwin str3:"$1: extended controls" content:1 {
        KSHD485_CELL($2$1)
    }
')
