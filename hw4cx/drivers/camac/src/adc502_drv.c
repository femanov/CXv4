...
static pzframe_chinfo_t chinfo[] =
{
    ...
    [ADC502_CHAN_RUN_MODE]      = {PZFRAME_CHTYPE_PZFRAME_STD, 0},
    [ADC502_CHAN_RUN]           = {PZFRAME_CHTYPE_PZFRAME_STD, 0},
...
enum
{
    ...
    PARAM_RUN_MODE = ADC502_CHAN_RUN_MODE,
    PARAM_RUN      = ADC502_CHAN_RUN,
