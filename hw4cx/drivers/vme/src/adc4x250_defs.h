...
enum
{
    ...
    ADC4X250_R_COMPILATION_TIMESTAMP_H = 0x00002C,
    ADC4X250_R_COMPILATION_TIMESTAMP_L = 0x000030,

    /* Specific registers */
    ADC4X250_R_STATUS             = 0x000100,
    ADC4X250_R_CTRL               = 0x000104,
    ADC4X250_R_TIMER              = 0x000108,
    ADC4X250_R_ADC_DECIM_RATIO    = 0x00010c,
    ...
    /* APD-specific registers */
    ADC4X250_R_APD_HV_CTRL_CHx_base=0x000148,
      ADC4X250_R_APD_HV_CTRL_CHx_incr=4,

    /* Thermo measurements registers */
    ADC4X250_R_THERMOSENSOR_CSR   = 0x000158,
    ADC4X250_R_THERMOSENSOR_TEMP  = 0x00015c,
...
enum
{
    ...
    ADC4X250_STATUS_PGA_NOT_DETECTED_shift       = 18, ADC4X250_STATUS_PGA_NOT_DETECTED       = 1 << ADC4X250_STATUS_PGA_NOT_DETECTED_shift,
    ADC4X250_STATUS_PGA_FLASH_FAILED_shift       = 19, ADC4X250_STATUS_PGA_FLASH_FAILED       = 1 << ADC4X250_STATUS_PGA_FLASH_FAILED_shift,
    ADC4X250_STATUS_FPGARTX_TIMEOUT_FAILED_shift = 20, ADC4X250_STATUS_FPGARTX_TIMEOUT_FAILED = 1 << ADC4X250_STATUS_FPGARTX_TIMEOUT_FAILED_shift,
    ADC4X250_STATUS_CMD_QUEUE_OVERFLOW_shift     = 21, ADC4X250_STATUS_CMD_QUEUE_OVERFLOW     = 1 << ADC4X250_STATUS_CMD_QUEUE_OVERFLOW_shift,
    ADC4X250_STATUS_PLL_WAS_UNLOCKED_shift       = 22, ADC4X250_STATUS_PLL_WAS_UNLOCKED       = 1 << ADC4X250_STATUS_PLL_WAS_UNLOCKED_shift,
};
enum
{
...
/* ADC4X250_R_ADC_DECIM_RATIO */
enum
{
    ADC4X250_ADC_DECIM_RATIO_MIN = 0,
    ADC4X250_ADC_DECIM_RATIO_MAX = 65535,
};

/* ADC4X250_R_ADC_TRIG_MODE -- not implemented (as of 06.07.2017; 21.01.2022 -- still not) */
enum
{
...
/* ADC4X250_R_THERMOSENSOR_CSR */
enum
{
    ADC4X250_THERMOSENSOR_CSR_START_shift      = 0, ADC4X250_THERMOSENSOR_CSR_START_mask = 1 << ADC4X250_THERMOSENSOR_CSR_START_shift,
    ADC4X250_THERMOSENSOR_CSR_RESOLUTION_shift = 1, 
     ADC4X250_THERMOSENSOR_CSR_RESOLUTION_bits = 0x3,
     ADC4X250_THERMOSENSOR_CSR_RESOLUTION_mask = ADC4X250_THERMOSENSOR_CSR_RESOLUTION_bits << ADC4X250_THERMOSENSOR_CSR_RESOLUTION_shift,
};
enum
{
    ADC4X250_THERMOSENSOR_RESOLUTION_1div2C  = 0,
    ADC4X250_THERMOSENSOR_RESOLUTION_1div4C  = 1,
    ADC4X250_THERMOSENSOR_RESOLUTION_1div8C  = 2,
    ADC4X250_THERMOSENSOR_RESOLUTION_1div16C = 3,
};
