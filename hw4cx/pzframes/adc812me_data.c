...
static pzframe_chan_dscr_t adc812me_chan_dscrs[] =
{
    ...
    [ADC812ME_CHAN_RUN_MODE]     = {"run_mode",     0, PZFRAME_CHAN_IMMEDIATE_MASK},
    [ADC812ME_CHAN_RUN]          = {"run",          0, PZFRAME_CHAN_IS_PARAM | PZFRAME_CHAN_RW_ONLY_MASK},
...
//    [] = {""},
    [ADC812ME_NUMCHANS] = {"_devstate", 0, PZFRAME_CHAN__DEVSTATE_MASK},
};
