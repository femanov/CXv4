...
#define PIV485_LYR_API_NAME "piv485"
enum
{
    PIV485_LYR_API_VERSION_MAJOR = 2,
    PIV485_LYR_API_VERSION_MINOR = 0,
    PIV485_LYR_API_VERSION = CX_ENCODE_VERSION(PIV485_LYR_API_VERSION_MAJOR,
                                               PIV485_LYR_API_VERSION_MINOR)
};
