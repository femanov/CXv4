...
#define PCI4624_LYR_API_NAME "pci4624"
enum
{
    PCI4624_LYR_API_VERSION_MAJOR = 2,
    PCI4624_LYR_API_VERSION_MINOR = 0,
    PCI4624_LYR_API_VERSION = CX_ENCODE_VERSION(PCI4624_LYR_API_VERSION_MAJOR,
                                                PCI4624_LYR_API_VERSION_MINOR)
};
